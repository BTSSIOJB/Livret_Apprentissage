<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="vueTravailEntrepriseParTuteur.aspx.cs" Inherits="web_livret_apprentissage_1.vueTravailEntrepriseParTuteur" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div id="tabs">
	        <ul>
		        <li><a href="#tabs-1">Aperçu du travail réalisé en entreprise par votre apprenti</a></li>
	        </ul>
          <div id="tabs-1">
                <br />
                &nbsp;
